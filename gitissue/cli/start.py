...
def main():
    ...
    try:
        ...
        cat_file_parser.add_argument('-t', '--type', action='store_true',
                                     help='instead of the content, show the object type identified by <object>.')
        cat_file_parser.add_argument('-s', '--size', action='store_true',
                                     help='instead of the content, show the object size identified by <object>.')
        cat_file_parser.add_argument('-p', '--print', action='store_true',
        ...
        tracker_parser.add_argument('--closed', action='store_true',
                                    help='shoe only issues that are closed')
