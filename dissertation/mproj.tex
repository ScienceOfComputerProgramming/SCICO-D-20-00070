...
Issue Tracking Systems (ITS) are at the forefront of collaborating tools for software development. Bertram (2010) argues that it is used by various groups in order to have a common point of knowledge on the product \cite{Bertram:2010}. Developers track issues them as a means to build up information on development tasks. Issues as development tasks are new features, bug fixes, preparations for releases, refactorings of old code, or any other such task. When developer work on the task or issue progress is made it is recorded in the ITS which provides vital information to managers and the team.
