...
@patch('sciit.issue.IssueSnapshot', autospec=True)
...
class TestSerializeDeserializeObject(TestCase):
    ...
    def setUp(self):
        ...
        self.data = {'filepath': 'here', 'contents': {'things': 1, 'item': '#IssueSnapshot for getting it right'}}
        self.hexsha = '1234'

    def test_serialize_object(self):
        self.hexsha = '23asdecs'
        serialize_repository_object_as_json(self.repo, self.hexsha, IssueSnapshot, self.data)
...
class TestGetTypeFromSha(TestCase):
    ...
    def setUp(self):
        ...
        self.issue = IssueSnapshot.create_from_data(self.repo, data)
