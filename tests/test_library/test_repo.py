...
class TestBuildIssueRepo(TestCase):
    ...
    @patch('sciit.repo.IssueRepo._find_latest_commit_hexsha_for_head', new_callable=MagicMock)
    ...
    def test_build_issue_cache_from_mocked_git_repo(
        ...
        find_latest_commit_for_head.return_value = self.head_commit.hexsha
